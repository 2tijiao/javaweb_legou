...
import { salerLogoutApi } from '@/apis/saler';

const router = useRouter();
const salerStore=useSalerStore()
const token=useTokenStore()
const handleLogout=async()=>{
    await salerLogoutApi();
    token.removeToken();
    router.push("/login")
};
</script>
    ...
    <el-container class="layout-container">
        ...
        <el-aside width="200px">
            ...
            <el-menu active-text-color="#ffd04b" background-color="#232323"  text-color="#fff"
                router>
                <el-menu-item index="/salerlayout">
                    <el-icon>
                        <Management />
                    </el-icon>
                    <span>商品种类管理</span>
        ...
        <el-container>
            <!-- 头部区域 -->
            <el-header>
                <div>欢迎回来: <strong>{{ salerStore.salerInfo.salerInfo.salername }}</strong></div>
            </el-header>
            <!-- 中间区域 -->
            <el-main>
